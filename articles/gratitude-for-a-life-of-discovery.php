...
<html
    ...
    <head>
        ...
        <title>Gratitude for a life of discovery</title>
        <?php include("../includes/sub_header.php"); ?>
        <link href="../css/articles.css" rel="stylesheet" type="text/css" />
        <style type="text/css">
.photo > .storyimage > .storyimage {
    background-image: url(../images/articles/gutman.jpg) !important;
}
.caption {
    diplay: block;
    padding: 5px;
...
<div class="content">
            ...
            <div class="article">
                <div class="image">
                    <div class="photo" title="Siegmund Gutman">
                ...
                <div class="bodycontent">
                    <p>Siegmund Gutman’s mind expanded at UC Santa Cruz, with interdisciplinary science and humanities courses setting the groundwork for his life of discovery and inquiry.</p>
                    <p>Now, Gutman (Crown ‘90, biochemistry and molecular biology), a Los Angeles-based intellectual property lawyer specializing in pharmaceutical patent cases, makes generous monthly donations to his alma mater.</p>
